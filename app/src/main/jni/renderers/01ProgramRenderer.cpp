...
//        LOGI("failed to create logical device!");
//    } else {
//        LOGI("Success to create logical device!");
//    }
//
...
//                                  &surface) != VK_SUCCESS) {
//        LOGI("failed to create window!");
//    } else {
//        LOGI("Success to create window!");
//    };
//}
//
...
bool InitVulkan(ANativeWindow *pWindow) {

    if (!InitVulkan()) {
        LOGI("Vulkan is unavailable, install vulkan and re-start");
        return false;
    }
    ...
    // create a device
    CreateVulkanDevice(pWindow, &appInfo);
